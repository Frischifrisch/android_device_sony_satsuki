        ...
        const std::string& value, bool for_emulator __attribute__((unused)))
{
	...
	//Dual Sim variant contains two IMEIs separated by comma.
        if ((count(value.begin(), value.end(),',')) > 0) {
                ...
                property_override("ro.product.model", "E6883");
                property_override("ro.product.name", "satsuki_dsds");
                property_override("ro.product.device", "satsuki_dsds");
                property_override("ro.build.description", "satsuki_dsds-user 7.1.1 N-MR1-KITAKAMI-170609-1025 1 dev-keys");
                property_override("ro.build.fingerprint", "Sony/satsuki_dsds/satsuki_dsds:7.1.1/N-MR1-KITAKAMI-170609-1025/1:user/dev-keys");
        } else {
                property_set("ro.telephony.default_network", "9");
                property_set("ro.semc.product.model", "E6853");
                property_set("ro.semc.product.name", "Xperia Z5 Premium");
                property_override("ro.product.model", "E6853");
                property_override("ro.product.name", "satsuki");
                property_override("ro.product.device", "satsuki");
                property_override("ro.build.description", "satsuki-user 7.1.1 N-MR1-KITAKAMI-170609-1025 1 dev-keys");
                property_override("ro.build.fingerprint", "Sony/satsuki/satsuki:7.1.1/N-MR1-KITAKAMI-170609-1025/1:user/dev-keys");
        }
    }
}
